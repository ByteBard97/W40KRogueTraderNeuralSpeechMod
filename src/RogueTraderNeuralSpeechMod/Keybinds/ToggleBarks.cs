...
using NeuralSpeechMod.Configuration.Settings;
using System;
#if DEBUG
using UnityEngine;
#endif

namespace NeuralSpeechMod.KeyBinds;
...
public class ToggleBarks() : ModHotkeySettingEntry(KEY, TITLE, TOOLTIP, DEFAULT_VALUE)
{
    ...
    {
        private static string _barksTurnedOnText = "NeuralSpeechMod: Barks turned ON!";
        private static string _barksTurnedOffText = "NeuralSpeechMod: Barks turned OFF!";
